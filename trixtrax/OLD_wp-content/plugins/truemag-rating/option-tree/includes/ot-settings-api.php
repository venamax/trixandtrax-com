          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
				...
				echo '<p class="option-tree-ui-button left image"></p>';
				echo '<p class="option-tree-ui-button left vesion ">V 1.0</p>';
				...
				echo '<p class="option-tree-ui-button right document"><a href="#">Documentation</a></p>';
				echo '<p class="option-tree-ui-button grey right imgok1"><a href="#"></a></p>';
				echo '<p class="option-tree-ui-button grey right support"><a href="#">Support Forum</a></p>';
				echo '<p class="option-tree-ui-button grey right imgok2"><a href="#"></a></p>';
