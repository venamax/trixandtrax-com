...
<div id="pizarra">
    	<div class="fondo-pizarra">
            ...
            <div id="scrollbar1">
                    ...
                    <div class="lista-colegios">
                        ...
                        <div class="item <?php echo $class; ?>">
                            <div class="colegio"><img src="<?php echo $imagen->guid; ?>"></div>
                            <div class="info"><div class="nombre-colegio"><?php echo str_replace('-', ' ', str_replace('@', '', $row->name)); ?></div></div>
                            <div class="puntos-bg"><div class="puntos">LIKES</div><div class="puntos-cantidad"><?php echo $row->likes; ?></div></div>
                        </div></a>
                            <?php
                            $index++;
                        }
         ...
         <div class="inf-pizarra">
          ...
          <div class="info"><div class="texto-verde">PARTICIPA</div> Dandole like a los videos de tu colegio favorito.</div>
        </div>
