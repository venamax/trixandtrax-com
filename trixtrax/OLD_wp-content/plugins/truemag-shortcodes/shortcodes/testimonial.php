...
class WPBakeryShortCode_Testimonial_item extends WPBakeryShortCode_VC_Tab {
...
class WPBakeryShortCode_Testimonial extends WPBakeryShortCode {
    ...
    protected function content( $atts, $content = null ) {
        ...
        $title = $auto_play = $interval = $width = $el_position = $el_class = $animation_class = '';
        //
		...
		$output .= "\n\t".'<div class="is-carousel simple-carousel testimonial" '.$data_auto.' id="post-gallery'.$id.'">';
