...
if(!function_exists('tm_echo_responsive_ad')){
	function tm_echo_responsive_ad($publisher_id,$ad_slot_id){
		$idx = rand(0,1000);
?>
...
if(!function_exists('tm_display_ads')){
...
?>
		<div class='ad <?php echo $section;?>'><?php tm_echo_responsive_ad($adsense_publisher_id, $adsense_slot_top_1);?></div>
	<?php
	} elseif($ad_top_1 != ''){?>
...
if(!function_exists('tm_adsense_responsive')){
	function tm_adsense_responsive($atts){
		...
		if($pub_id != '' && $slot_id != ''){
?>
		<div class='ad <?php echo $class;?>'><?php tm_echo_responsive_ad($pub_id,$slot_id);?></div>
<?php
		}
	}
}
